...
1. **实盘交易风险**：实盘交易存在风险，请谨慎使用（已完成回测验证，实盘链路已修复已知风险，详见 [CHANGELOG](CHANGELOG.md)，建议先用模拟盘验证）
...
本项目基于 zhiyizhilu/qmt-backtrader 修改，原版权归原作者所有，仅供学习和研究使用，不构成任何投资建议。使用者应自行承担使用本项目的全部风险和责任。
